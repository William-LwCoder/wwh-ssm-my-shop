...
import com.wwh.my.shop.commons.utils.EmailSendUtils;
import com.wwh.my.shop.web.ui.api.UsersApi;
...
//            emailSendUtils.send("用户登录", String.format("用户 【%s】 登录 MyShop", user.getUsername()), "xxx@qq.com");
            // 将会员信息放入 Session
